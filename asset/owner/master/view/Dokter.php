...
<div class="col-md-10 main-content">
    <h5 class="mb-4 mt fw-bold">Dokter Overview</h5>

    <!-- Form Input Transaksi -->
    <div class="card mt-4">
        <div class="card-body">
            <h5 class="card-title mb-4">Input Dokter Baru</h5>
            <form action="app/dokter/input.php" method="post">
                <div class="row">
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="app/dokter/delete.php?id=<?= $row_karyawan['id'] ?>" class="btn btn-danger delete" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')">Delete</a>
                                </td>
                            </tr>
        ...
        <div
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content" style="border: 1px solid #000; box-shadow: 4px 4px 0 0 rgba(0, 0, 0, 0.9);">
                    ...
                    <form action="app/dokter/update.php" method="post">
