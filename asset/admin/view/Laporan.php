<div class="col-md-10 main-content">
    ...
    <div class="card mt-4">
        <div class="card-body">
            ...
            <form action="../owner/laporan/pdf/rekap_transaksi.php" method="get">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>Rp. <?= $data['total'] ?></td>
                                <td>
                                    <a href="../owner/laporan/pdf/transaksi.php?notrans=<?= $data['notrans'] ?>" class="btn btn-success" target="_blank" style="border: 1px solid #000;">
